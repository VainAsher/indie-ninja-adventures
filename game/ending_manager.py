...
class EndingManager:
    ...
    def __init__(self):
        ...
        self.ending_data: EndingData | None = None

        # Callbacks for game integration
        self.on_choice_callback: Callable | None = None
        self.on_ending_complete_callback: Callable | None = None
    ...
    def get_ending_cutscene_data(self) -> dict | None:
        """
        ...
        return {
            ...
            "scenes": [
                ...
                },
                {
                    ...
                    "text": ("Why...? After everything I took from you...?"),
                    "duration": 3.0,
                },
                {
                    "type": "dialogue",
                ...
                {"type": "credits", "text": "THE END - The Path of Mercy", "duration": 3.0},
            ],
        }
        ...
        return {
            ...
            "scenes": [
                ...
                },
                {
                    ...
                    "speaker": "Narrator",
                    "text": (
                        "The veil dissipates into shadow. She is gone. " "The threat is ended."
                    ),
                    "duration": 3.0,
                },
                {
                ...
                {"type": "credits", "text": "THE END - The Path of Justice", "duration": 3.0},
            ],
        }
    ...
    def get_hub_final_state(self) -> dict | None:
    ...
    def get_ending_achievement_data(self) -> dict | None:
