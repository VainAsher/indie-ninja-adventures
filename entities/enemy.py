...
ENEMY_DEFINITIONS = {
    EnemyType.GOBLIN: EnemyDefinition(
        ...
        max_hp=3,
        base_damage=1,
        move_speed=180.0,  # 37.5% of player speed - balanced medium enemy
        width=32,
        height=48,
    ...
    EnemyType.BAT: EnemyDefinition(
        ...
        max_hp=2,
        base_damage=1,
        move_speed=240.0,  # 50% of player speed - fast flying enemy
        width=24,
        height=24,
    ...
    EnemyType.SLIME: EnemyDefinition(
        ...
        max_hp=5,
        base_damage=1,
        move_speed=120.0,  # 25% of player speed - slow tanky enemy
        width=40,
        height=32,
    ...
    EnemyType.SKELETON: EnemyDefinition(
        ...
        max_hp=4,
        base_damage=2,
        move_speed=200.0,  # 42% of player speed - balanced medium-fast enemy
        width=32,
        height=56,
    ...
    EnemyType.WOLF: EnemyDefinition(
        ...
        max_hp=4,
        base_damage=2,
        move_speed=260.0,  # 54% of player speed - fast aggressive enemy
        width=48,
        height=32,
