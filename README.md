...
> Version: **v0.11.71** | Status: External playtest ready | Platform: Windows | Engine: Java 21 + libGDX + Netty
...
## What's in v0.11.71 (player animation pack integration, input/minimap polish, CI formatting gate fix)
