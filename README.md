...
> Version: **v0.12.00** | Status: External playtest ready | Platform: Windows | Engine: Java 21 + libGDX + Netty
...
## What's in v0.12.00 (repository cleanup, workflow adoption, distribution-lane hardening)
