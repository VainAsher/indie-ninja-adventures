...
> Version: **v0.12.01** | Status: External playtest ready | Platform: Windows | Engine: Java 21 + libGDX + Netty
...
## What's in v0.12.01 (mission objective pickup hard guarantee in multiplayer-hosted runs)
