...
> Version: **v0.11.70** | Status: External playtest ready | Platform: Windows | Engine: Java 21 + libGDX + Netty
...
## What's in v0.11.70 (schema $id crash fix, DevConsole projection fix, CI stabilisation)
