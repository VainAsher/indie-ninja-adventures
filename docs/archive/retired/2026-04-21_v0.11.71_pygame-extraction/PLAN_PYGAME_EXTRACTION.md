...
- [x] Freeze new feature work in python prototype lane (bugfix/security-only).
...
- [x] Move split-era historical docs to archive.
- [x] Re-run workflow/docs audit and close extraction plan.
...
- Closure tasks completed: split-era notes archived and extraction docs/workflow audit rerun.
