...
FRAME_GROUPS = {
    ...
    "wolf": {
        "idle.png":     ["idle-"],
        "run.png":      ["run-"],      # wolf uses run, not walk
...
def main():
    ...
    with open(readme, "w") as f:
        ...
        f.write("|------|--------------|-------|\n")
        f.write("| swordsman | 1 Enemy | Greatsword; slow heavy attacks |\n")
        f.write("| skeleton  | 2 Enemy | Shield fighter; GUARD blocks melee |\n")
        f.write("| slime     | 3 Enemy | Multi-hit; no jump |\n")
        f.write("| grunt     | 4 Enemy | Spear fighter; longer reach |\n")
        f.write("| wolf      | 5 Enemy | Archer/kiter; uses run sheet |\n")
